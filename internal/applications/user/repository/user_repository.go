...
type UserRepository interface {
	Create(ctx context.Context, client *ent.Tx, request ent.User) (*ent.User, error)
	Update(ctx context.Context, client *ent.Tx, request ent.User, id uint64) (*ent.User, error)
