...
func InitializedUserService(dbClient *ent.Client) *service.UserServiceImpl {
	...
	trxServiceImpl := transaction.NewTxServiceImpl(dbClient)
...
var providerUser = wire.NewSet(repository.NewUserRepositoryImpl, repository2.NewRoleRepositoryImpl, repository3.NewRoleUserRepositoryImpl, transaction.NewTxServiceImpl, service.NewUserServiceImpl, wire.Bind(new(repository.UserRepository), new(*repository.UserRepositoryImpl)), wire.Bind(new(repository2.RoleRepository), new(*repository2.RoleRepositoryImpl)), wire.Bind(new(repository3.RoleUserRepository), new(*repository3.RoleUserRepositoryImpl)), wire.Bind(new(transaction.TrxService), new(*transaction.TrxServiceImpl)), wire.Bind(new(service.UserService), new(*service.UserServiceImpl)))
