...
func NewBookRepository(dbClient *ent.Client) *BookRepositoryImpl {
	return &BookRepositoryImpl{
		dbClient: dbClient,
	}
}

func (r *BookRepositoryImpl) DatabaseAction(ctx context.Context, requestDomain *ent.Pet) (*ent.Pet, error) {
