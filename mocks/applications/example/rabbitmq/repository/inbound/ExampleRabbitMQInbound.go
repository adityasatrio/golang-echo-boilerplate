...
type mockConstructorTestingTNewExampleRabbitMQInbound interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewExampleRabbitMQInbound(t mockConstructorTestingTNewExampleRabbitMQInbound) *ExampleRabbitMQInbound {
