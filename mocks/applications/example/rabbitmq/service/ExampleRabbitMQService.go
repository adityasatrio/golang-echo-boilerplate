...
type mockConstructorTestingTNewExampleRabbitMQService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewExampleRabbitMQService(t mockConstructorTestingTNewExampleRabbitMQService) *ExampleRabbitMQService {
