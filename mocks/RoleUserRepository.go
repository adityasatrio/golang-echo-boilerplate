...
func (_m *RoleUserRepository) DeleteByUserId(ctx context.Context, client *ent.Client, id uint64) (int, error) {
	ret := _m.Called(ctx, client, id)

	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Client, uint64) (int, error)); ok {
		return rf(ctx, client, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Client, uint64) int); ok {
		r0 = rf(ctx, client, id)
	} else {
		r0 = ret.Get(0).(int)
	}
