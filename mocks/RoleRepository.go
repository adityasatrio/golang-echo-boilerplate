...
func (_m *RoleRepository) Create(ctx context.Context, request dto.RoleRequest) (*ent.Role, error) {
...
func (_m *RoleRepository) Update(ctx context.Context, request dto.RoleRequest, id uint64) (*ent.Role, error) {
