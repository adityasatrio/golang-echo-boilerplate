...
type mockConstructorTestingTNewWrappedChannelService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewWrappedChannelService(t mockConstructorTestingTNewWrappedChannelService) *WrappedChannelService {
