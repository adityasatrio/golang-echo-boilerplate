...
// Create provides a mock function with given fields: ctx, client, user
func (_m *UserRepository) Create(ctx context.Context, client *ent.Tx, user ent.User) (*ent.User, error) {
	ret := _m.Called(ctx, client, user)

	var r0 *ent.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Tx, ent.User) (*ent.User, error)); ok {
		return rf(ctx, client, user)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Tx, ent.User) *ent.User); ok {
		r0 = rf(ctx, client, user)
	} else {
		if ret.Get(0) != nil {
...
// Update provides a mock function with given fields: ctx, client, user, id
func (_m *UserRepository) Update(ctx context.Context, client *ent.Tx, user ent.User, id uint64) (*ent.User, error) {
	ret := _m.Called(ctx, client, user, id)

	var r0 *ent.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Tx, ent.User, uint64) (*ent.User, error)); ok {
		return rf(ctx, client, user, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Tx, ent.User, uint64) *ent.User); ok {
		r0 = rf(ctx, client, user, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ent.User)
		}
