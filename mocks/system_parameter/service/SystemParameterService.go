...
func (_m *SystemParameterService) Create(ctx context.Context, create *dto.SystemParameterCreateRequest) (*ent.System_parameter, error) {
	ret := _m.Called(ctx, create)

	var r0 *ent.System_parameter
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *dto.SystemParameterCreateRequest) (*ent.System_parameter, error)); ok {
		return rf(ctx, create)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *dto.SystemParameterCreateRequest) *ent.System_parameter); ok {
		r0 = rf(ctx, create)
	} else {
		if ret.Get(0) != nil {
...
func (_m *SystemParameterService) Delete(ctx context.Context, id int) (*ent.System_parameter, error) {
...
func (_m *SystemParameterService) GetAll(ctx context.Context) ([]*ent.System_parameter, error) {
	ret := _m.Called(ctx)
...
func (_m *SystemParameterService) GetById(ctx context.Context, id int) (*ent.System_parameter, error) {
	ret := _m.Called(ctx, id)
...
func (_m *SystemParameterService) Update(ctx context.Context, id int, update *dto.SystemParameterUpdateRequest) (*ent.System_parameter, error) {
	ret := _m.Called(ctx, id, update)

	var r0 *ent.System_parameter
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int, *dto.SystemParameterUpdateRequest) (*ent.System_parameter, error)); ok {
		return rf(ctx, id, update)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int, *dto.SystemParameterUpdateRequest) *ent.System_parameter); ok {
		r0 = rf(ctx, id, update)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ent.System_parameter)
