...
const (
	...
	// Node types.
	TypeAtlasSchemaRevision = "AtlasSchemaRevision"
	TypePet                 = "Pet"
	TypeSystem_parameter    = "System_parameter"
	TypeUser                = "User"
)

// AtlasSchemaRevisionMutation represents an operation that mutates the AtlasSchemaRevision nodes in the graph.
type AtlasSchemaRevisionMutation struct {
	config
	op                Op
	typ               string
	id                *string
	...
	error_stmt        *string
	hash              *string
	partial_hashes    **schema.PartialHashes
	operator_version  *string
	clearedFields     map[string]struct{}
	done              bool
	oldValue          func(context.Context) (*AtlasSchemaRevision, error)
	predicates        []predicate.AtlasSchemaRevision
}

var _ ent.Mutation = (*AtlasSchemaRevisionMutation)(nil)

// atlasschemarevisionOption allows management of the mutation configuration using functional options.
type atlasschemarevisionOption func(*AtlasSchemaRevisionMutation)

// newAtlasSchemaRevisionMutation creates new mutation for the AtlasSchemaRevision entity.
func newAtlasSchemaRevisionMutation(c config, op Op, opts ...atlasschemarevisionOption) *AtlasSchemaRevisionMutation {
	m := &AtlasSchemaRevisionMutation{
		config:        c,
		op:            op,
		typ:           TypeAtlasSchemaRevision,
...
// withAtlasSchemaRevisionID sets the ID field of the mutation.
func withAtlasSchemaRevisionID(id string) atlasschemarevisionOption {
	return func(m *AtlasSchemaRevisionMutation) {
		var (
			err   error
			once  sync.Once
			value *AtlasSchemaRevision
		)
		m.oldValue = func(ctx context.Context) (*AtlasSchemaRevision, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().AtlasSchemaRevision.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withAtlasSchemaRevision sets the old AtlasSchemaRevision of the mutation.
func withAtlasSchemaRevision(node *AtlasSchemaRevision) atlasschemarevisionOption {
	return func(m *AtlasSchemaRevisionMutation) {
		m.oldValue = func(context.Context) (*AtlasSchemaRevision, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
func (m AtlasSchemaRevisionMutation) Client() *Client {
...
func (m AtlasSchemaRevisionMutation) Tx() (*Tx, error) {
...
// operation is only accepted on creation of AtlasSchemaRevision entities.
func (m *AtlasSchemaRevisionMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *AtlasSchemaRevisionMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *AtlasSchemaRevisionMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	...
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().AtlasSchemaRevision.Query().Where(m.predicates...).IDs(ctx)
	default:
...
func (m *AtlasSchemaRevisionMutation) SetDescription(s string) {
	m.description = &s
}

// Description returns the value of the "description" field in the mutation.
func (m *AtlasSchemaRevisionMutation) Description() (r string, exists bool) {
	v := m.description
	if v == nil {
		return
	}
...
// OldDescription returns the old "description" field's value of the AtlasSchemaRevision entity.
// If the AtlasSchemaRevision object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AtlasSchemaRevisionMutation) OldDescription(ctx context.Context) (v string, err error) {
...
func (m *AtlasSchemaRevisionMutation) ResetDescription() {
	m.description = nil
}

// SetType sets the "type" field.
func (m *AtlasSchemaRevisionMutation) SetType(u uint64) {
	m._type = &u
	m.add_type = nil
}

// GetType returns the value of the "type" field in the mutation.
func (m *AtlasSchemaRevisionMutation) GetType() (r uint64, exists bool) {
	v := m._type
	if v == nil {
		return
	}
...
// OldType returns the old "type" field's value of the AtlasSchemaRevision entity.
// If the AtlasSchemaRevision object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AtlasSchemaRevisionMutation) OldType(ctx context.Context) (v uint64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AtlasSchemaRevisionMutation) AddType(u int64) {
	if m.add_type != nil {
		*m.add_type += u
	} else {
		m.add_type = &u
...
func (m *AtlasSchemaRevisionMutation) AddedType() (r int64, exists bool) {
	v := m.add_type
	if v == nil {
		return
	}
...
func (m *AtlasSchemaRevisionMutation) ResetType() {
	m._type = nil
	m.add_type = nil
}

// SetApplied sets the "applied" field.
func (m *AtlasSchemaRevisionMutation) SetApplied(i int) {
	m.applied = &i
	m.addapplied = nil
}

// Applied returns the value of the "applied" field in the mutation.
func (m *AtlasSchemaRevisionMutation) Applied() (r int, exists bool) {
	v := m.applied
	if v == nil {
		return
	}
...
// OldApplied returns the old "applied" field's value of the AtlasSchemaRevision entity.
// If the AtlasSchemaRevision object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AtlasSchemaRevisionMutation) OldApplied(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AtlasSchemaRevisionMutation) AddApplied(i int) {
	if m.addapplied != nil {
		*m.addapplied += i
	} else {
		m.addapplied = &i
...
func (m *AtlasSchemaRevisionMutation) AddedApplied() (r int, exists bool) {
	v := m.addapplied
	if v == nil {
		return
	}
...
func (m *AtlasSchemaRevisionMutation) ResetApplied() {
	m.applied = nil
	m.addapplied = nil
}

// SetTotal sets the "total" field.
func (m *AtlasSchemaRevisionMutation) SetTotal(i int) {
	m.total = &i
	m.addtotal = nil
}

// Total returns the value of the "total" field in the mutation.
func (m *AtlasSchemaRevisionMutation) Total() (r int, exists bool) {
	v := m.total
	if v == nil {
		return
	}
...
// OldTotal returns the old "total" field's value of the AtlasSchemaRevision entity.
// If the AtlasSchemaRevision object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AtlasSchemaRevisionMutation) OldTotal(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AtlasSchemaRevisionMutation) AddTotal(i int) {
	if m.addtotal != nil {
		*m.addtotal += i
	} else {
		m.addtotal = &i
...
func (m *AtlasSchemaRevisionMutation) AddedTotal() (r int, exists bool) {
	v := m.addtotal
	if v == nil {
		return
	}
...
func (m *AtlasSchemaRevisionMutation) ResetTotal() {
	m.total = nil
	m.addtotal = nil
}

// SetExecutedAt sets the "executed_at" field.
func (m *AtlasSchemaRevisionMutation) SetExecutedAt(t time.Time) {
	m.executed_at = &t
}

// ExecutedAt returns the value of the "executed_at" field in the mutation.
func (m *AtlasSchemaRevisionMutation) ExecutedAt() (r time.Time, exists bool) {
	v := m.executed_at
	if v == nil {
		return
	}
...
// OldExecutedAt returns the old "executed_at" field's value of the AtlasSchemaRevision entity.
// If the AtlasSchemaRevision object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AtlasSchemaRevisionMutation) OldExecutedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AtlasSchemaRevisionMutation) ResetExecutedAt() {
	m.executed_at = nil
}

// SetExecutionTime sets the "execution_time" field.
func (m *AtlasSchemaRevisionMutation) SetExecutionTime(i int) {
	m.execution_time = &i
	m.addexecution_time = nil
}

// ExecutionTime returns the value of the "execution_time" field in the mutation.
func (m *AtlasSchemaRevisionMutation) ExecutionTime() (r int, exists bool) {
	v := m.execution_time
	if v == nil {
		return
	}
...
// OldExecutionTime returns the old "execution_time" field's value of the AtlasSchemaRevision entity.
// If the AtlasSchemaRevision object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AtlasSchemaRevisionMutation) OldExecutionTime(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AtlasSchemaRevisionMutation) AddExecutionTime(i int) {
...
func (m *AtlasSchemaRevisionMutation) AddedExecutionTime() (r int, exists bool) {
...
func (m *AtlasSchemaRevisionMutation) ResetExecutionTime() {
	m.execution_time = nil
	m.addexecution_time = nil
}

// SetError sets the "error" field.
func (m *AtlasSchemaRevisionMutation) SetError(s string) {
	m.error = &s
}

// Error returns the value of the "error" field in the mutation.
func (m *AtlasSchemaRevisionMutation) Error() (r string, exists bool) {
	v := m.error
	if v == nil {
		return
	}
...
// OldError returns the old "error" field's value of the AtlasSchemaRevision entity.
// If the AtlasSchemaRevision object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AtlasSchemaRevisionMutation) OldError(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AtlasSchemaRevisionMutation) ClearError() {
	m.error = nil
	m.clearedFields[atlasschemarevision.FieldError] = struct{}{}
}

// ErrorCleared returns if the "error" field was cleared in this mutation.
func (m *AtlasSchemaRevisionMutation) ErrorCleared() bool {
	_, ok := m.clearedFields[atlasschemarevision.FieldError]
	return ok
}

// ResetError resets all changes to the "error" field.
func (m *AtlasSchemaRevisionMutation) ResetError() {
	m.error = nil
	delete(m.clearedFields, atlasschemarevision.FieldError)
}

// SetErrorStmt sets the "error_stmt" field.
func (m *AtlasSchemaRevisionMutation) SetErrorStmt(s string) {
	m.error_stmt = &s
}

// ErrorStmt returns the value of the "error_stmt" field in the mutation.
func (m *AtlasSchemaRevisionMutation) ErrorStmt() (r string, exists bool) {
	v := m.error_stmt
	if v == nil {
		return
	}
...
// OldErrorStmt returns the old "error_stmt" field's value of the AtlasSchemaRevision entity.
// If the AtlasSchemaRevision object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AtlasSchemaRevisionMutation) OldErrorStmt(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AtlasSchemaRevisionMutation) ClearErrorStmt() {
	m.error_stmt = nil
	m.clearedFields[atlasschemarevision.FieldErrorStmt] = struct{}{}
}

// ErrorStmtCleared returns if the "error_stmt" field was cleared in this mutation.
func (m *AtlasSchemaRevisionMutation) ErrorStmtCleared() bool {
	_, ok := m.clearedFields[atlasschemarevision.FieldErrorStmt]
	return ok
}

// ResetErrorStmt resets all changes to the "error_stmt" field.
func (m *AtlasSchemaRevisionMutation) ResetErrorStmt() {
	m.error_stmt = nil
	delete(m.clearedFields, atlasschemarevision.FieldErrorStmt)
}

// SetHash sets the "hash" field.
func (m *AtlasSchemaRevisionMutation) SetHash(s string) {
	m.hash = &s
}

// Hash returns the value of the "hash" field in the mutation.
func (m *AtlasSchemaRevisionMutation) Hash() (r string, exists bool) {
	v := m.hash
	if v == nil {
		return
	}
...
// OldHash returns the old "hash" field's value of the AtlasSchemaRevision entity.
// If the AtlasSchemaRevision object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AtlasSchemaRevisionMutation) OldHash(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AtlasSchemaRevisionMutation) ResetHash() {
	m.hash = nil
}

// SetPartialHashes sets the "partial_hashes" field.
func (m *AtlasSchemaRevisionMutation) SetPartialHashes(sh *schema.PartialHashes) {
	m.partial_hashes = &sh
}

// PartialHashes returns the value of the "partial_hashes" field in the mutation.
func (m *AtlasSchemaRevisionMutation) PartialHashes() (r *schema.PartialHashes, exists bool) {
	v := m.partial_hashes
	if v == nil {
		return
	}
...
// OldPartialHashes returns the old "partial_hashes" field's value of the AtlasSchemaRevision entity.
// If the AtlasSchemaRevision object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AtlasSchemaRevisionMutation) OldPartialHashes(ctx context.Context) (v *schema.PartialHashes, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AtlasSchemaRevisionMutation) ClearPartialHashes() {
	m.partial_hashes = nil
	m.clearedFields[atlasschemarevision.FieldPartialHashes] = struct{}{}
}

// PartialHashesCleared returns if the "partial_hashes" field was cleared in this mutation.
func (m *AtlasSchemaRevisionMutation) PartialHashesCleared() bool {
	_, ok := m.clearedFields[atlasschemarevision.FieldPartialHashes]
	return ok
}

// ResetPartialHashes resets all changes to the "partial_hashes" field.
func (m *AtlasSchemaRevisionMutation) ResetPartialHashes() {
	m.partial_hashes = nil
	delete(m.clearedFields, atlasschemarevision.FieldPartialHashes)
}

// SetOperatorVersion sets the "operator_version" field.
func (m *AtlasSchemaRevisionMutation) SetOperatorVersion(s string) {
	m.operator_version = &s
}

// OperatorVersion returns the value of the "operator_version" field in the mutation.
func (m *AtlasSchemaRevisionMutation) OperatorVersion() (r string, exists bool) {
...
// OldOperatorVersion returns the old "operator_version" field's value of the AtlasSchemaRevision entity.
// If the AtlasSchemaRevision object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AtlasSchemaRevisionMutation) OldOperatorVersion(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AtlasSchemaRevisionMutation) ResetOperatorVersion() {
	m.operator_version = nil
}

// Where appends a list predicates to the AtlasSchemaRevisionMutation builder.
func (m *AtlasSchemaRevisionMutation) Where(ps ...predicate.AtlasSchemaRevision) {
	m.predicates = append(m.predicates, ps...)
}

// Op returns the operation name.
func (m *AtlasSchemaRevisionMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (AtlasSchemaRevision).
func (m *AtlasSchemaRevisionMutation) Type() string {
	return m.typ
}
...
// AddedFields().
func (m *AtlasSchemaRevisionMutation) Fields() []string {
	fields := make([]string, 0, 11)
	if m.description != nil {
		fields = append(fields, atlasschemarevision.FieldDescription)
	}
	if m._type != nil {
		fields = append(fields, atlasschemarevision.FieldType)
	}
	if m.applied != nil {
		fields = append(fields, atlasschemarevision.FieldApplied)
	}
	if m.total != nil {
		fields = append(fields, atlasschemarevision.FieldTotal)
	}
	if m.executed_at != nil {
		fields = append(fields, atlasschemarevision.FieldExecutedAt)
	}
	if m.execution_time != nil {
		fields = append(fields, atlasschemarevision.FieldExecutionTime)
	}
	if m.error != nil {
		fields = append(fields, atlasschemarevision.FieldError)
	}
	if m.error_stmt != nil {
		fields = append(fields, atlasschemarevision.FieldErrorStmt)
	}
	if m.hash != nil {
		fields = append(fields, atlasschemarevision.FieldHash)
	}
	if m.partial_hashes != nil {
		fields = append(fields, atlasschemarevision.FieldPartialHashes)
	}
	if m.operator_version != nil {
		fields = append(fields, atlasschemarevision.FieldOperatorVersion)
	}
	return fields
}
...
// schema.
func (m *AtlasSchemaRevisionMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// database failed.
func (m *AtlasSchemaRevisionMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case atlasschemarevision.FieldDescription:
	...
	return nil, fmt.Errorf("unknown AtlasSchemaRevision field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *AtlasSchemaRevisionMutation) SetField(name string, value ent.Value) error {
	switch name {
	case atlasschemarevision.FieldDescription:
		v, ok := value.(string)
		if !ok {
	...
	case atlasschemarevision.FieldHash:
		...
		return nil
	case atlasschemarevision.FieldPartialHashes:
		v, ok := value.(*schema.PartialHashes)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
	...
	return fmt.Errorf("unknown AtlasSchemaRevision field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *AtlasSchemaRevisionMutation) AddedFields() []string {
	var fields []string
	if m.add_type != nil {
		fields = append(fields, atlasschemarevision.FieldType)
	}
...
func (m *AtlasSchemaRevisionMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case atlasschemarevision.FieldType:
		return m.AddedType()
	case atlasschemarevision.FieldApplied:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *AtlasSchemaRevisionMutation) AddField(name string, value ent.Value) error {
	switch name {
	case atlasschemarevision.FieldType:
		v, ok := value.(int64)
		if !ok {
	...
	return fmt.Errorf("unknown AtlasSchemaRevision numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *AtlasSchemaRevisionMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(atlasschemarevision.FieldError) {
		fields = append(fields, atlasschemarevision.FieldError)
	}
	if m.FieldCleared(atlasschemarevision.FieldErrorStmt) {
		fields = append(fields, atlasschemarevision.FieldErrorStmt)
	}
	if m.FieldCleared(atlasschemarevision.FieldPartialHashes) {
		fields = append(fields, atlasschemarevision.FieldPartialHashes)
	}
	return fields
}
...
func (m *AtlasSchemaRevisionMutation) FieldCleared(name string) bool {
...
func (m *AtlasSchemaRevisionMutation) ClearField(name string) error {
	switch name {
	case atlasschemarevision.FieldError:
		m.ClearError()
		return nil
	...
	return fmt.Errorf("unknown AtlasSchemaRevision nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *AtlasSchemaRevisionMutation) ResetField(name string) error {
	switch name {
	case atlasschemarevision.FieldDescription:
		m.ResetDescription()
		return nil
...
func (m *AtlasSchemaRevisionMutation) AddedEdges() []string {
...
func (m *AtlasSchemaRevisionMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *AtlasSchemaRevisionMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *AtlasSchemaRevisionMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *AtlasSchemaRevisionMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *AtlasSchemaRevisionMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *AtlasSchemaRevisionMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown AtlasSchemaRevision unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *AtlasSchemaRevisionMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown AtlasSchemaRevision edge %s", name)
}
