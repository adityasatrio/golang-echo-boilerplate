...
func (*SystemParameter) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		default:
			return nil, fmt.Errorf("unexpected column %q for type SystemParameter", columns[i])
		}
	}
	return values, nil
}
...
func (sp *SystemParameter) Update() *SystemParameterUpdateOne {
	return (&SystemParameterClient{config: sp.config}).UpdateOne(sp)
}
...
func (sp SystemParameters) config(cfg config) {
	for _i := range sp {
		sp[_i].config = cfg
	}
}
...
func (m *SystemParameter) MarshalBinary() ([]byte, error) {
	return json.Marshal(m)
}

/*func (m *SystemParameter) UnmarshalBinary(data []byte) error {
	return json.Unmarshal(data, m)
}*/

func (m *SystemParameter) UnmarshalBinary(data string) error {
