...
var (
	...
	PetsColumns = []*schema.Column{
		...
		{Name: "versions", Type: field.TypeInt64, Default: 1767413187822810112},
	...
	RolesColumns = []*schema.Column{
		...
		{Name: "versions", Type: field.TypeInt64, Default: 1767413187823940608},
		{Name: "created_by", Type: field.TypeString},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_by", Type: field.TypeString, Nullable: true},
		{Name: "updated_at", Type: field.TypeTime},
	...
	RoleUsersColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUint64, Increment: true},
		{Name: "versions", Type: field.TypeInt64, Default: 1767413187824011776},
		{Name: "created_by", Type: field.TypeString},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_by", Type: field.TypeString, Nullable: true},
		{Name: "updated_at", Type: field.TypeTime},
	...
	SystemParametersColumns = []*schema.Column{
		...
		{Name: "versions", Type: field.TypeInt64, Default: 1767413187824054784},
		{Name: "created_by", Type: field.TypeString},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_by", Type: field.TypeString, Nullable: true},
		{Name: "updated_at", Type: field.TypeTime},
	...
	UsersColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUint64, Increment: true},
		{Name: "versions", Type: field.TypeInt64, Default: 1767413187824101376},
		{Name: "created_by", Type: field.TypeString},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_by", Type: field.TypeString, Nullable: true},
		{Name: "updated_at", Type: field.TypeTime},
	...
	UserDevicesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUint64, Increment: true},
		{Name: "versions", Type: field.TypeInt64, Default: 1767413187824194560},
		{Name: "created_by", Type: field.TypeString},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_by", Type: field.TypeString, Nullable: true},
		{Name: "updated_at", Type: field.TypeTime},
